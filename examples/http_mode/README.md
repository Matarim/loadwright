...
Booting Puma, real concurrency, and connection-pool findings.

## What this will demonstrate

- Which findings become available only in :http mode
- Which findings become unavailable in :in_process, and why they are reported as unavailable rather than as zero
